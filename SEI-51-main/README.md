...
# Welcome everyone to General Assembly Toronto SEI!
...
- Course duration: Monday, May 30th, 2022 - Friday, August 19th, 2022
- Holidays:
  - Canada Day - July-1st
...
[Link to join the Zoom Room](https://generalassembly.zoom.us/j/95350431511?pwd=QlBSRndkQVk5aXVObWoxWVN6SHBYdz09)
...
| :------------------- | :------------ | :----------------- | :----------------------------- |
| Instructor           | David Bland   | @David Bland       | david.bland@generalassemb.ly   |
| Assistant Instructor | Jibran Supple | @Jibran Supple     | jibran.supple@generalassemb.ly |
| Assistant Instructor | Jivesh Bhatti | @Jivesh - SEI - TA | jivesh.bhatti@generalassemb.ly |
...
2. In another tab, browse to the GA class repo: [https://git.generalassemb.ly/sei-toronto/sei-51](https://git.generalassemb.ly/sei-toronto/sei-51)
...
```
$ git clone https://git.generalassemb.ly/YOUR-ENTERPRISE-GITHUB-USERNAME/sei-51
```

You can now `$ cd sei-51` and check out your local copy of of the GA class repo!
...
```
$ git remote add upstream https://git.generalassemb.ly/sei-toronto/sei-51.git
```
