...
2. (optional) (hard) Make it so that clicking the 'add' button on a food changes the `lineItems` property in state to insert the food you clicked on. Some notes:
	...
	- You'll also have to consider the case where "add to cart" is being clicked for an item already in the array. If you really need a hint in the form of code, you can find a partial handleAddToCart method <a href="https://gist.git.generalassemb.ly/alexanderghose/52bf27c1c6f69cef84caad063c4a9d3c">here</a>.
