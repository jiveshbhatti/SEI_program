...
In a future lesson we'll focus on the data model (state) that our website requires.
...
## components step 2- make it show up / render it / call it:

Regardless of what syntax you use to define a component, to render it(ie., make it show up), you can use the syntax below.
...
If a component relies on some props, to make it show up, you might do something like this. Here we're providing a "concert" prop to the Card which you can ignore for now. Again, we'll talk more about props later:
